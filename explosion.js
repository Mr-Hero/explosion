...
function Particle(){
	...
	this.domElement.style.background = 'url(image/orangeParticle.png) transparent'; 
	domElement.style.position = 'absolute';
	domElement.style.display = 'block'; 
	domElement.style.width = "32px";
	domElement.style.height = "32px";

	domElement.style.transformOrigin = "16px 16px";
	domElement.style.webkitTransformOrigin = "16px 16px";
	domElement.style.mozTransformOrigin = "16px 16px";
	domElement.style.msTransformOrigin = "16px 16px";
	domElement.style.oTransformOrigin = "16px 16px";
	...
	this.update = function(){
		...
		domElement.style.transform = "translate3d("+this.x+"px, "+this.y+"px, "+this.z+"px) scale("+this.size+")";
		domElement.style.webkitTransform = "translate3d("+this.x+"px, "+this.y+"px, "+this.z+"px) scale("+this.size+")";
		domElement.style.mozTransform = "translate3d("+this.x+"px, "+this.y+"px, "+this.z+"px) scale("+this.size+")";
		domElement.style.msTransform = "translate3d("+this.x+"px, "+this.y+"px, "+this.z+"px) scale("+this.size+")"; 
		domElement.style.oTransform = "translate3d("+this.x+"px, "+this.y+"px, "+this.z+"px) scale("+this.size+")";
